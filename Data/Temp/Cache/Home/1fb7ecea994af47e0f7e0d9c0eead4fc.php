...
<section class="k1120">
      ...
      <div class="viewMain">
        <p>
          <img src="/Public/Charmy/images/products/newproduct01_img.jpg" alt="">
        </p>
      <!--
        <div class="paging">
          <a href="/index.php?a=product_detail&productname=xzlm"><i class="fa fa-angle-double-left"></i></a>
          <a href="/index.php?a=product_detail&productname=ygqm"><i class="fa fa-angle-double-right"></i></a>
        </div>
      -->
      </div>
    </section>
